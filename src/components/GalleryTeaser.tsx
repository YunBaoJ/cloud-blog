...
export default function GalleryTeaser() {
  return (
    <section data-home-scroll-section className="relative min-h-[100dvh] w-full overflow-hidden bg-transparent px-4 py-20 sm:px-6 md:py-28 lg:px-8">
      ...
      <div data-home-scroll-content className="relative z-10 mx-auto max-w-[1180px] space-y-8 sm:space-y-10">
        {/* Header */}
        <div data-home-scroll-heading className="gallery-card-anim flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <div data-home-scroll-rail>
          <div className="relative left-1/2 grid w-full -translate-x-1/2 grid-cols-1 items-start justify-items-center gap-6 pt-28 sm:grid-cols-2 lg:w-[min(1300px,calc(100vw-3rem))] lg:grid-cols-4 lg:gap-7 lg:pt-32">
            ...
            return (
              ...
              >
                ...
                {/* Inner Polaroid Card */}
                <div className={`relative flex w-full flex-col justify-between rounded-3xl border border-[#2D2B2C]/5 bg-white p-4 shadow-[0_10px_28px_rgba(45,43,44,0.08)] transition-[transform,box-shadow,border-color] duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] will-change-transform dark:border-white/10 dark:bg-[#1C2A20] dark:shadow-[0_8px_24px_rgba(0,0,0,0.3)] ${style.rotate} group-hover:z-20 motion-safe:group-hover:-translate-y-3 motion-safe:group-hover:rotate-0 motion-safe:group-hover:scale-[1.02] group-hover:border-[#36513B]/28 group-hover:shadow-[0_25px_44px_rgba(45,43,44,0.18)]`}>
                  ...
                  <div className="relative mb-4 aspect-[4/3] overflow-hidden rounded-2xl border border-[#2D2B2C]/5 bg-[#FAF7F2] dark:border-white/10 dark:bg-[#121B15]">
                    <Image
                      ...
                      className="object-cover transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] motion-safe:group-hover:scale-[1.045]"
                    />
                    
                    <div className="absolute top-2.5 right-2.5 rounded-full bg-black/50 px-2 py-0.5 text-[9px] font-medium text-white backdrop-blur-md transition-transform duration-300 motion-safe:group-hover:-translate-y-1">
                      {photo.categoryLabel}
                    </div>
                  </div>
