            ...
            return (
              ...
              >
                ...
                <div className={`relative flex w-full flex-col justify-between rounded-2xl border border-[#2D2B2C]/5 bg-white p-4 shadow-[0_10px_28px_rgba(45,43,44,0.08)] transition-all duration-500 ease-out transform dark:border-white/10 dark:bg-[#1C2A20] dark:shadow-[0_8px_24px_rgba(0,0,0,0.3)] ${style.rotate} group-hover:z-20 group-hover:-translate-y-3 group-hover:rotate-0 group-hover:scale-[1.02] group-hover:shadow-[0_22px_42px_rgba(45,43,44,0.16)]`}>
                  ...
                  <div className="relative mb-4 aspect-[4/3] overflow-hidden rounded-xl border border-[#2D2B2C]/5 bg-[#FAF7F2] dark:border-white/10 dark:bg-[#121B15]">
                    <Image
                      src={photo.src}
                      alt={photo.title}
                      fill
